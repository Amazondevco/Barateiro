...
export const en: Record<string, string> = {
  ...
  Foto: "Photo",
  "1 foto": "1 photo",
  'Preencha "{campo}".': 'Fill in "{campo}".',
  'Adicione observação em "{campo}".': 'Add a note on "{campo}".',
  'Adicione foto em "{campo}".': 'Add a photo on "{campo}".',
  "Adicione a assinatura antes de enviar.":
    "Add your signature before submitting.",
  // opções de resposta
  OK: "OK",
  NÃO: "NO",
  Sim: "Yes",
  ...
  "App bloqueado. Use a biometria ou o código do celular para entrar.":
    "App locked. Use biometrics or your phone passcode to enter.",
  Desbloquear: "Unlock",
  ...
  "Gestão e acompanhamento da rede.": "Management and monitoring for the network.",
  "Não foi possível abrir o console.": "Couldn't open the console.",
};
